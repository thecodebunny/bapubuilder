    ...
    model: linkType.model.extend({
        defaults: Object.assign({}, linkType.model.prototype.defaults, {
            traits: [
                {
                    type: 'text',
                    label: '<?= bb_trans('pagebuilder.trait-manager.link.text') ?>',
                    name: 'content',
                    changeProp: 1,
                },
                {
                ...
                {
                    type: 'select',
                    label: '<?= bb_trans('pagebuilder.trait-manager.link.target') ?>',
                    name: 'target',
                    options: [
                        {value: '_blank', name: '<?= bb_trans('pagebuilder.yes') ?>'},
                        {value: false, name: '<?= bb_trans('pagebuilder.no') ?>'},
                    ],
                }
            ],
        }),
