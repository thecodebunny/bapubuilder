...
use Thecodebunny\Bapubuilder\Modules\GrapesJS\PageRenderer;
 ...
 *
 * @package Thecodebunny\Bapubuilder\GrapesJS
 */
class BlockAdapter
{
    /**
    ...
    public function getCategory()
    {
        ...
        return bb_trans('pagebuilder.default-category');
    }
    ...
    public function getBlockManagerArray()
    {
        ...
        if (file_exists($this->block->getThumbPath())) {
            $img = '<div class="block-thumb"><img src="' . bb_full_url($this->block->getThumbUrl()) . '"></div>';
        }
    ...
    public function getBlockSettingsArray()
    {
        ...
        foreach ($blockSettings as $name => $blockSetting) {
            ...
            if ($type === 'select') {
                ...
                $setting['type'] = 'select';
                $setting['options'] = [
                    ['id' => 0, 'name' => bb_trans('pagebuilder.no')],
                    ['id' => 1, 'name' => bb_trans('pagebuilder.yes')]
                ];
            }
