...
use Thecodebunny\Bapubuilder\Modules\GrapesJS\Block\BaseController;
use Thecodebunny\Bapubuilder\Modules\GrapesJS\Block\BaseModel;
...
class ThemeBlock
{
    ...
    {
        $themesPath = config('theme.folder');
    ...
    {
        return bb_theme_asset('block-thumbs/' . md5($this->blockSlug) . '/' . md5(file_get_contents($this->getViewFile())) . '.jpg');
    }
